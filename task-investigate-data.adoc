...
---
= Investigate data in your organization with NetApp Data Classification
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
NOTE: The December 2023 (version 1.26.6) release removed the option to calculate the number of personally identifiable information (PII) data by Directories. 
...
[TIP]
After filtering data, you can link:task-copy-move.html[copy, move, and delete unstructured files] to improve compliance or optimize storage. 
...
* link:task-copy-move.html[Copy, move, and delete data from the Investigation dashboard]