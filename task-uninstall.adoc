...
. Select **Uninstall Data Classification**. 
...
. In the dialog, enter "uninstall" to proceed with disconnecting the Data Classification instance from the Console agent. Select **Uninstall** to confirm. 
