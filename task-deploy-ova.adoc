...
. The _Deploy Data Classification On Premises_ dialog appears. Copy the provided command, such as `sudo ./install.sh -a 12345 -c 27AG75 -t 2198qq`, to a text file for later use. Select *Close* to dismiss the dialog.
