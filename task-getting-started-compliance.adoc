...
. Select the system you want to add or modify the CIFS credentials for. 
...
. On the Configuration page, select *Configuration* then choose the system to review the status for each CIFS and NFS volume and correct any errors.
