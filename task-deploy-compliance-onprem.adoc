...
[IMPORTANT]
For OVA installation, you can skip preparing the host system. 
...
. Download the Data Classification software from the https://mysupport.netapp.com/site/products/all/details/cloud-data-sense/downloads-tab/[NetApp Support Site^]. Select the file name *DATASENSE-INSTALLER-<version>.tar.gz*.
