...
If the Azure NetApp Files system you want to scan is not already in the NetApp Console as system, link:https://docs.netapp.com/us-en/storage-management-azure-netapp-files/task-quick-start.html[add it in the Systems page^]. 
