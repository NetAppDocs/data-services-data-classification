...
To get into Swagger you'll need the IP address of your Data Classification instance. In the case of a cloud deployment you'll use the public IP address. Then you'll need to get into this endpoint: 
