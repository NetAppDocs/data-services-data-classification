...
First, get the relevant fields and options for a system to view the filters in the Investigation tab.
...
Use that response in the request parameters to filter the files that you want to copy. 
