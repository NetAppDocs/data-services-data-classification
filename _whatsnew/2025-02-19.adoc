...
Prioritization is limited to link:https://docs.netapp.com/us-en/bluexp-classification/concept-classification.html[mapping-only scans^]; it's not available for map and classify scans. 
// https://docs.netapp.com/us-en/bluexp-classification/concept-classification.html[What's the difference between Mapping and Classification scans?]
