...
When conducting Map-only scans, you can prioritize the most important scans. This feature helps when you have many working environments and want to ensure high priority scans are completed first. 
...
Prioritization is limited to link:https://docs.netapp.com/us-en/data-services-data-classification/concept-classification.html[map-only scans^]; it's not available for map and classify scans. 
