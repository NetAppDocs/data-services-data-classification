...
Data Classification now supports a Compliance admin role to manage permissions in Data Classification. The Compliance admin roles doesn't have access to resources including Console agents and workspaces. Users with the Compliance admin role must be associated with at least one other role. 
