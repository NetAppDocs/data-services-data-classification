...
[role="quick-margin-para"]
You can also https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-on-prem.html[install the Console agent on-premises^] on a Linux host in your network or on a Linux host in the cloud.
...
As you can see, there may be some situations where you need to use https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html#multiple-connectors[multiple Console agents].
...
https://docs.netapp.com/us-en/console-setup-admin/task-install-restricted-mode.html[See more information about deploying the Console agent in a Government region^].
