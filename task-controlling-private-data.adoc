...
---
= View compliance details about organizational private data with NetApp Data Classification
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[NOTE]
File-level compliance details are only available if you perform a full classification scan. Map-only scans don't yield file-level details. 
...
+
image:screenshot_compliance_investigation_page.png[A screenshot of detailed information found in files after selecting Investigate Results.]
+
image:screenshot_compliance_investigation_page_directory.png[A screenshot of detailed information found in directories after selecting Investigate Results.]
...
. Investigate the data by searching, sorting, expanding details for a specific file, selecting *Investigate Results* to see masked information, or by downloading the file list.
