...
. To change the scan type for individual buckets, shares, or volumes, select the **Active scans** tab. Apply the appropriate filters to identify the resources you want to modify. 
+
image:screenshot_compliance_config_button.png[A screenshot showing how to select the Configuration button for a system.]
+
In the Scan type column, select the designated resource and change it to **Mapping only** or **Full scan**. 
...
.Steps
. From the Data Classification menu, select *Configuration*. 
. Select the **Active scans** tab. 
. Optionally, apply the appropriate filters to identify the resources you want to modify. Find the resources you want to prioritize. Select the action menu `...` option then *Prioritize scan*.
...
. From the Data Classification menu, select *Configuration*. 
. Select the **Active scans** tab.
. Optionally, apply the appropriate filters to identify the resources you want to modify. Identify the resources you want to pause. For each resource, select the action menu `...` option then *Pause scan*.
+
