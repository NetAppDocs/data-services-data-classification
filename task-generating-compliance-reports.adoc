...
---
= View compliance reports in NetApp Data Classification
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[NOTE]
====
* Compliance reports are only available if you perform a full classification scan on your data sources. Data sources that have had a map-only scan can only generate the Data Mapping Report.
