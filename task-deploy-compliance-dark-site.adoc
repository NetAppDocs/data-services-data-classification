...
[NOTE]
The Data Classification installer reserves UID 4321 and GID 4321. Before starting installation, ensure UID 4321 and GID 4321 aren't in use on the host machine. If UID and GID 4321 are being used, the installation will fail with an invalid user error message. 
