...
summary: With Data Classification, you can reduce storage costs by identifying stale data, duplicate files, and large files, then removing or tiering them to less expensive object storage
---
= View governance details about organizational data with NetApp Data Classification
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
. Within each Savings Opportunities tile of the Governance dashboard, select *Optimize Storage* to view the filtered results in the Investigation page. To discover any data you should delete or tier to less expensive storage, investigate the _Saving Opportunities_.
...
. From Data Classification, select *Governance*.
. In the reports tile, select the **Download** button in the Full data mapping overview report heading.
+
